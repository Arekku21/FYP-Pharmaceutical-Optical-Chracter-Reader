...
header("Location: $login_page");
  ...
  <ul class="menu-list" style="width: 80%;">
    ...
    <li class="newclass :hover">
      <a class="btn" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'" href="../report/overview.php" style="color:white; text-align: left"><span class="icon"><i class="fa fa-folder-open" style="margin-right: 7px;"></i></span>Report</a>
    </li>
    <li class="newclass :hover">
