...
else if($_POST["action"] == "proceedRefund")
{
    ...
    if(mysqli_num_rows($sql) > 0)
    {
        ...
        $update = mysqli_query($Links, "UPDATE tblpurchase_invoice SET refundedItem = '".$refundedItem."', refundedBatchNo = '".$refundedBatchNo."', refundedDrugQty = '".$refundedDrugQty."', refundedDrugPrice = '".$refundedDrugPrice."', refundedTax = '6:".$refundedTax."' WHERE purchaseInvoiceID=".$_POST["id"]."");
