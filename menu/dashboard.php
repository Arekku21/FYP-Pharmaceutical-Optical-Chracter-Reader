...
?>
<div style="margin-top: 0%; width:101vw;">
<div class="container-fluid">
  <div class="row-fluid" style="...">
    <div class="card" style="width:28rem; border-style:solid; border-width:10px; border-radius:10px; float:right; margin-top:5%; margin-right:30px;">
      <div class="card-body">
        ...
        <div class="card" style="width:28rem; border-style:solid; border-width:10px; border-radius:10px; float:right; margin-top:5%; margin-right:10px;">
        <div class="card-body">
        ...
        <div class="card" style="width:56.5rem; height:27rem; border-style:solid; border-width:10px; border-radius:5px; float:right; margin-top:15px; margin-right:30px;">
        <div class="card-body">
        ...
        <div class="card" style="width:28rem; border-style:solid; border-width:10px; border-radius:10px; float:right; margin-top:15px; margin-right:10px; ">
        <div class="card-body">
